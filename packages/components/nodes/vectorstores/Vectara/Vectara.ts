    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                name: 'filter',
                description:
                    'Filter to apply to Vectara metadata. Refer to the <a target="_blank" href="https://docs.agentVizai.com/vector-stores/vectara">documentation</a> on how to use Vectara filters with agentViz.',
                type: 'string',
