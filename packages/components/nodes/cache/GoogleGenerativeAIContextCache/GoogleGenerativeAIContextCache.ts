...
import agentVizGoogleAICacheManager from './agentVizGoogleAICacheManager'
...
class GoogleGenerativeAIContextCache implements INode {
    ...
    constructor() {
        ...
        this.category = 'Cache'
        this.baseClasses = [this.type, ...getBaseClasses(agentVizGoogleAICacheManager)]
        this.inputs = [
            {
                label: 'TTL',
                name: 'ttl',
    ...
    async init(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        const manager = new agentVizGoogleAICacheManager(apiKey)
