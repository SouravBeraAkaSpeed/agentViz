...
const embedPopupHtmlCode = (chatflowid) => {
    ...
    import Chatbot from "https://cdn.jsdelivr.net/npm/agentViz-embed/dist/web.js"
    Chatbot.init({
...
const embedPopupReactCode = (chatflowid) => {
    return `import { BubbleChat } from 'agentViz-embed-react'
...
const embedFullpageHtmlCode = (chatflowid) => {
    return `<agentViz-fullchatbot></agentViz-fullchatbot>
<script type="module">
    import Chatbot from "https://cdn.jsdelivr.net/npm/agentViz-embed/dist/web.js"
    Chatbot.initFull({
        chatflowid: "${chatflowid}",
...
const embedFullpageReactCode = (chatflowid) => {
    return `import { FullPageChat } from "agentViz-embed-react"
...
export const defaultThemeConfig = {
    ...
    disclaimer: {
        title: 'Disclaimer',
        message: 'By using this chatbot, you agree to the <a target="_blank" href="https://agentVizai.com/terms">Terms & Condition</a>',
        textColor: 'black',
        buttonColor: '#3b82f6',
    ...
    chatWindow: {
        ...
        footer: {
            ...
            text: 'Powered by',
            company: 'agentViz',
            companyLink: 'https://agentVizai.com'
        }
    }
}
                            ...
                            <span>
                                ...
                                <p>
                                    ...
                                    <a
                                        rel='noreferrer'
                                        target='_blank'
                                        href='https://www.npmjs.com/package/agentViz-embed?activeTab=versions'
                                    >
                                        version
                                    </a>
                                    :&nbsp;<code>{`https://cdn.jsdelivr.net/npm/agentViz-embed@<version>/dist/web.js`}</code>
                                </p>
                            </span>
