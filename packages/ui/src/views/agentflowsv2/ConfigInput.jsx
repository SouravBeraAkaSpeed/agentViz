...
export const ConfigInput = ({ data, inputParam, disabled = false, arrayIndex = null, parentParamForArray = null }) => {
    ...
    const onCustomDataChange = ({ inputParam, newValue }) => {
        ...
        const credential = updatedInputs.credential || updatedInputs[agentViz_CREDENTIAL_ID]
    ...
    useEffect(() => {
        const loadComponentData = async () => {
            ...
            const credential = componentNodeData.inputs.credential || componentNodeData.inputs[agentViz_CREDENTIAL_ID]
